...
contract(' newContract', ([contractOwner, secondAddress, thirdAddress]) => {
    let new_contract
    ...
    before(async() => {
        new_contract = await newContract.deployed()
    })
    ...
    describe('deployment', () => {
        ...
        it('deploys successfully', async() => {
            const address = await new_contract.address
        ...
        it('has a message', async() => {
            const message = await new_contract.message()
    ...
    describe('message', () => {
        ...
        it('contract owner sets a message', async() => {
                // set new message
                await new_contract.setMessage('Hi there!', { from: contractOwner })
        ...
        it('address that is not the owner fails to set a message', async() => {
            await new_contract.setMessage('Hi there!', { from: secondAddress })
                .should.be.rejected
                // this tells Chai that the test should pass if the setMessage function fails.
            await new_contract.setMessage('Hi there!', { from: thirdAddress })
                .should.be.rejected
        })
    })
})